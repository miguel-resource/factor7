...
export default function ContactPage() {
  return (
    <CommonWrapper>
      ...
      mb-10 mt-10 text-slate-700 text-center  justify-center w-10/12 
      lg:px-0 lg:text-center lg:items-center lg:justify-center lg:flex-row lg:gap-10 lg:mt-20 lg:mb-20"
      >
        <form
          className="flex gap-7 flex-col mx-auto  w-10/12 mb-10 md:w-9/12 lg:mx-auto lg:px-0 lg:w-7/12 lg:mb-0"
          action=""
          method="post"
          style={{
            // width: "48em",
